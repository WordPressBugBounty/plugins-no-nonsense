...
class R34NoNo {
	...
	public function __construct() {
		...
		if (is_plugin_active('jetpack/jetpack.php')) {
			...
			$this->settings['r34nono_remove_dashboard_widgets']['options']['jetpack_summary_widget'] = 'Jetpack'; // Don't translate plugin name
		...
		if (is_plugin_active('wordfence/wordfence.php')) {
			...
			// Remove Dashboard widget
			$this->settings['r34nono_remove_dashboard_widgets']['options']['wordfence_activity_report_widget'] = 'Wordfence'; // Don't translate plugin name
			asort($this->settings['r34nono_remove_dashboard_widgets']['options']);
		...
		if (is_plugin_active('wp-mail-smtp/wp_mail_smtp.php')) {
			...
			// Remove Dashboard widget
			$this->settings['r34nono_remove_dashboard_widgets']['options']['wp_mail_smtp_reports_widget_lite'] = 'WP Mail SMTP'; // Don't translate plugin name
			asort($this->settings['r34nono_remove_dashboard_widgets']['options']);
	...
	private function _get_version() {
		...
		$plugin_data = get_plugin_data(dirname(__FILE__) . '/no-nonsense.php', false, false);
